...
| [Backend API & SQL](backend/sql/README.md) | SQL scripts and API notes. |
...
- **Project structure** → See [PROJECT_STRUCTURE.md](../PROJECT_STRUCTURE.md) in the repo root.
- **Main readme** → [README.md](../README.md) (overview, quick start, architecture).
