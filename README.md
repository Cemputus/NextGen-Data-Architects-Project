...
### 4. ETL and warehouse ERD

This view shows the warehouse-centric data model generated by ETL, including core dimensions and facts in `ucu_datawarehouse`, plus operational data relationships used by analytics and reporting endpoints.

<img src="readme-images/05-erd-etl-data-warehouse-ucu_datawarehouse.png" alt="ERD — ETL and Data Warehouse (ucu_datawarehouse)" width="920" />
