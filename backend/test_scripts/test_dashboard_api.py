...
try:
    ...
    if stats_response.status_code == 200:
        ...
        print(f"   FAIL Stats failed: {stats_response.status_code}")
...
try:
    ...
    if dept_response.status_code == 200:
        ...
        print("   OK Department data retrieved")
        ...
        print(f"   FAIL Failed: {dept_response.status_code}")
